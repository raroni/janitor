...
(function(/*! Stitch !*/) {
...
}).call(this)({"asserts": function(exports, require, module) {(function() {
  module.exports = {
...
}, "event_emitter": function(exports, require, module) {(function() {
  module.exports = {
    ...
    trigger: function(event, message) {
      ...
      if (!(this._callbacks && (list = this._callbacks[event]))) {
        return;
      }
      _results = [];
...
}, "failed_assert_message_resolver": function(exports, require, module) {(function() {
  module.exports = (function() {
  ...
  module.exports = (function() {
    function _Class(tests, options) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        Test = _ref[_i];
        Test.bind('runCompleted', __bind(function(test_run) {
          return this.handleCompletedRun(test_run);
        }, this));
        Test.bind('completed', __bind(function() {
    ...
    _Class.prototype.checkComplete = function() {
      this.completed += 1;
      if (this.completed === this.tests.length) {
...
}, "runner": function(exports, require, module) {(function() {
  module.exports = (function() {
  ...
  module.exports = (function() {
    ...
    _Class.run = function(method_name) {
      ...
      run.bind('completed', __bind(function() {
        return this.runCompleted(run);
      }, this));
      run.run();
    ...
    _Class.runCompleted = function(run) {
      ...
      this.completed += 1;
      if (this.completed === this.testMethodNames().length) {
        return this.complete();
      }
    };
...
}, "underscore": function(exports, require, module) {//     Underscore.js 1.1.7
//     (c) 2011 Jeremy Ashkenas, DocumentCloud Inc.
//     Underscore is freely distributable under the MIT license.
//     Portions of Underscore are inspired or borrowed from Prototype,
//     Oliver Steele's Functional, and John Resig's Micro-Templating.
